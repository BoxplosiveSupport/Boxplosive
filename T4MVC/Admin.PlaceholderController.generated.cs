...
{
    public partial class PlaceholderController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PlaceholderController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected PlaceholderController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PlaceholderController Actions { get { return MVC.AdminArea.Placeholder; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Placeholder";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Placeholder";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Admin/Views/Placeholder/Create.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/Placeholder/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PlaceholderController : nl.boxplosive.BackOffice.Mvc.Areas.Admin.Controllers.PlaceholderController
    {
        public T4MVC_PlaceholderController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, nl.boxplosive.BackOffice.Mvc.Areas.Admin.Models.PlaceholderCreateModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(nl.boxplosive.BackOffice.Mvc.Areas.Admin.Models.PlaceholderCreateModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
