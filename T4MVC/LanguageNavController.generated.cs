...
{
    public partial class LanguageNavController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public LanguageNavController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected LanguageNavController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public LanguageNavController Actions { get { return MVC.LanguageNav; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "LanguageNav";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "LanguageNav";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/LanguageNav/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_LanguageNavController : nl.boxplosive.BackOffice.Mvc.Controllers.LanguageNavController
    {
        public T4MVC_LanguageNavController() : base(Dummy.Instance) { }
