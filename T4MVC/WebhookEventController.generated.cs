...
{
    public partial class WebhookEventController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public WebhookEventController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected WebhookEventController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public WebhookEventController Actions { get { return MVC.WebhookEvent; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "WebhookEvent";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "WebhookEvent";
        ...
        public class ActionParamsClass_Index
        {
            ...
            public readonly string eventState = "eventState";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/WebhookEvent/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_WebhookEventController : nl.boxplosive.BackOffice.Mvc.Controllers.WebhookEventController
    {
        public T4MVC_WebhookEventController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string eventType, int? pageSize, int? pageNumber, string eventState, string from, string to);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(string eventType, int? pageSize, int? pageNumber, string eventState, string from, string to)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "eventType", eventType);
            ...
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "eventState", eventState);
            ...
            IndexOverride(callInfo, eventType, pageSize, pageNumber, eventState, from, to);
            return callInfo;
        }

        [NonAction]
        partial void IndexPostOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string eventType, int? pageSize, int? pageNumber, string eventState, System.DateTime? from, System.DateTime? to);

        [NonAction]
        public override System.Web.Mvc.ActionResult IndexPost(string eventType, int? pageSize, int? pageNumber, string eventState, System.DateTime? from, System.DateTime? to)
        {
            ...
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "from", from);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "to", to);
            IndexPostOverride(callInfo, eventType, pageSize, pageNumber, eventState, from, to);
            return callInfo;
        }
