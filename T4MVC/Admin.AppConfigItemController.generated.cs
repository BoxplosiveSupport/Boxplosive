...
{
    public partial class AppConfigItemController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AppConfigItemController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected AppConfigItemController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AppConfigItemController Actions { get { return MVC.AdminArea.AppConfigItem; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "AppConfigItem";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "AppConfigItem";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Admin/Views/AppConfigItem/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AppConfigItemController : nl.boxplosive.BackOffice.Mvc.Areas.Admin.Controllers.AppConfigItemController
    {
        public T4MVC_AppConfigItemController() : base(Dummy.Instance) { }
