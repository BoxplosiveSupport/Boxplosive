...
{
    public partial class ManageProductsController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ManageProductsController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ManageProductsController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ManageProductsController Actions { get { return MVC.ManageProducts; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ManageProducts";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ManageProducts";
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string UploadCsv = "UploadCsv";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/ManageProducts/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ManageProductsController : nl.boxplosive.BackOffice.Mvc.Controllers.ManageProductsController
    {
        public T4MVC_ManageProductsController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void UploadCsvOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult UploadCsv()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.UploadCsv);
            UploadCsvOverride(callInfo);
            return callInfo;
        }
